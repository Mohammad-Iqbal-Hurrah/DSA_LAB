...
int main()
{
    ...
    d.insert(0, 20);      //calling push function and pushing 20 at 0 index
    d.insert(1, 70);      //calling push function again and pushing 70 at 1 index
    ...
    cout << d.dlt();    //calling pop method to remove and print the last element at a specific index
